...
met = "E:/MUSIC/saudiEnvirozone/arldata", out = "C:/hysplit/",hours = 120, height = 500, hy.path = "C:/hysplit/") {
...
file.name <- paste(out, name, Year,'-',height, ".RData", sep = "")
...
#}
file.remove(Sys.glob("C:/hysplit/working/tdump*"))
file.remove(Sys.glob("C:/hysplit/working/Rcombined.txt"))
procTraj(lat = 22.0, lon = 42.0, start = "2024-01-01 00:00:00", end = "2024-01-15 00:00:00", name = "NDL", hours = 120, height = 1000 ,
met = "E:/MUSIC/saudiEnvirozone/arldata/", out = "C:/hysplit/",
hy.path = "C:/hysplit/")
