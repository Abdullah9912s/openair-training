####line 6 8,18,21 130
## /home/sateesh/hysplitsat/hysplit/TrajProc/
##Delhi  76.95 08.48
##
##
#~/hysplitsat/hysplit/trunk/working/
#/imd/antarctica-pmrd/2017R
procTraj <- function(lat = 08.48, lon = 76.95, start = "2016-01-01 00:00:00", end = "2016-01-31 00:00:00", name = "5YDarjeeling",
met = "/home/user16/hysplit/sateesh/arl/", out = "/home/user16/hysplit/sateesh/TrajProc/",hours = 120, height = 500, hy.path = "/home/user16/hysplit/trunk/") {
...
write.table(x, bat.file, col.names = FALSE,
row.names = FALSE, quote = FALSE, append = TRUE)
x <- "/home/user16/hysplit/trunk/exec/hyts_std"
write.table(x, bat.file, col.names = FALSE,
row.names = FALSE, quote = FALSE, append = TRUE)
## run the file
...
file.name <- paste(out, name, Year,'-',500, ".RData", sep = "")
...
##for (i in 2016) {
##for i in 2016 {
#procTraj(lat = 08.48, lon = 76.95, year = i,
#name = "5YDarjeeling", hours = 120,
#met = "/home/user16/hysplit/sateesh/arl/", out = "/home/user16/hysplit/sateesh/TrajProc/",
#hy.path = "/home/user16/hysplit/trunk/")
#}
file.remove(Sys.glob("/home/user16/hysplit/trunk/working/tdump*"))
file.remove(Sys.glob("/home/user16/hysplit/trunk/working/Rcombined.txt"))
procTraj(lat = 28.58, lon = 77.20, start = "2016-01-01 00:00:00", end = "2021-12-31 00:00:00", name = "NDL", hours = 120, height = 500 ,
met = "/home/user16/hysplit/sateesh/arl/", out = "/home/user16/hysplit/sateesh/TrajProc/",
hy.path = "/home/user16/hysplit/trunk/")
